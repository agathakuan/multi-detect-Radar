...
public class DeviceScanActivity extends ListActivity {
    ...
    private String mRegisterRoomNum;
    public static final String REGISTER_ROOM = "REGISTERED_ROOM";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRegisterRoomNum = intent.getStringExtra(MainActivity.REGISTER_ROOM);
    ...
    private class LeDeviceListAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if("BT05".equals(device.getName()))
            {
                ...
                try{
                    if(device.getAddress().equals(gv.getRoomAddr(roomList.get(0))))
                        deviceName = roomList.get(0);
                    else if(device.getAddress().equals(gv.getRoomAddr(roomList.get(1))))
                        deviceName = roomList.get(1);
                    else if(device.getAddress().equals(gv.getRoomAddr(roomList.get(2))))
                        deviceName = roomList.get(2);
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        intent.putExtra(REGISTER_ROOM, mRegisterRoomNum);
